...
export class HomeComponent {
  servicios:{icon:string, titulo:string, texto:string}[] = [
    ...
    {icon:'check', titulo:'...y márcalas como realizadas', texto: '¿Ya completaste una de tus tareas? Puedes marcarla como realizada e incluso borrarla de tu lista. Si le pusiste tiempo a tu tarea y no la completaste antes de esa fecha, siempre puedes cambiarle la fecha. También puedes cambiar las descripciones si te equivocaste.'}
  ];
}
